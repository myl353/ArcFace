...
两个优化器：分类-Adam，arcloss-Adam   对分类优化器加上学习率衰减
...
import os
#必须要引用，不然3d图是会报错，引用from mpl_toolkits.mplot3d import Axes3D也可以
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.out_layer=nn.Linear(3,10,bias=False)
...
if __name__ == '__main__':
    model_path='models/arcface_mnist09_3d.pth'
    arcloss_path = 'models/acrface_minist_arc09_3d.pth'
